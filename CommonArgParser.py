#!/usr/bin/env python
"""CommonArgParser is an sub-class of ArgumentParser
...
class CommonArgParser(ArgumentParser):
    ...
    Examples:
    >>> import CommonArgParser
    >>> parser = CommonArgParser.CommonArgParser('my-prog')
    ...
    def parse_args(self, args=None, namespace=None):
        ...
        """Parse arguments"""
        result = super(CommonArgParser, self).parse_args(args, namespace)
    ...
    def parse_env(self, args=None):
        ...
        for env_name in self.env_def:
            ...
            try:
                if not CommonArgParser._is_env_valid(
...
if __name__ == '__main__':
    ...
    CommonArgParser('parser').parse_args(["-v", "DEBUG"])
    logging.debug("debug")
    logging.info("info")
